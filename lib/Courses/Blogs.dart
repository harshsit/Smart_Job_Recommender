...
class SearchBlogsPage extends StatefulWidget {
 SearchBlogsPage({Key key, this.title,this.usertok}) : super(key: key);
final String title;
final String usertok;

  @override
  _SearchBlogsPageState createState() => new _SearchBlogsPageState();
}
...
class _SearchBlogsPageState extends State<SearchBlogsPage> {
  ...
  Future<void> fetchJobs() async {
    final response = await http.get(
      'http://harshraj.pythonanywhere.com/content/Recommended-blogs/',
   ...
   //  print( _blogs);
     ...
     data1 = responseJson['Blogs_list']['data'] ;
     print(data1);
    print(data1.length);
